					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-heading">
								<a href="reg-users_tambah.php" class="btn btn-success">Tambah</a>
							</div>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									?>	
										<tr>
											...
											<td><?php echo htmlentities($result['npm']);?></td>
											<td><?php echo htmlentities($result['kelas']);?></td>
											<td align="center">
												...
												<a href="reg-users_edit.php?id=<?php echo $result['id_user'];?>" class="btn btn-warning btn-xs">&nbsp;&nbsp;Ubah&nbsp;&nbsp;</a>&nbsp;&nbsp;
												<a href="reg-users_hapus.php?id=<?php echo $result['id_user'];?>" onclick="return confirm('Apakah anda yakin akan menghapus Data Mahasiswa <?php echo $result['nama_user'];?>?');" class="btn btn-danger btn-xs">&nbsp;&nbsp;Hapus&nbsp;&nbsp;</a>
											</td>
										</tr>
										<?php } ?>
