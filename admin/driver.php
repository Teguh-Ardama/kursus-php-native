	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">Data Asesor</h2>
									...
									<?php 
										...
										<tr>
											...
											<td align="center">
												...
												<a href="drv_hapus.php?id=<?php echo $result['id_driver'];?>" onclick="return confirm('Apakah anda yakin akan menghapus Asesor <?php echo $result['nama_driver'];?>?');" class="btn btn-danger btn-xs">&nbsp;&nbsp;Hapus&nbsp;&nbsp;</a>
											</td>
										</tr>
										<?php } ?>
									</tbody>
