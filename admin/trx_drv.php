			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Booking Menunggu Assign Asesor</h2>
						
						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Daftar Booking Menunggu Assign Asesor</div>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
										...
										$sqlsewa = "SELECT transaksi.*,paket.*,member.* FROM transaksi, paket, member 
													...
													AND transaksi.stt_trx='Terverifikasi' AND transaksi.id_driver='0'
										...
										<tr align="center">
											...
											<td>
											<a href="trx_assign.php?id=<?php echo $result['id_trx'];?>" class="btn btn-warning btn-xs">&nbsp;&nbsp;Assign Asesor&nbsp;&nbsp;</a></td>
										</tr>
										<?php }?>
									</tbody>
								</table>
