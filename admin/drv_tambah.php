	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">Tambah Data Asesor</h2>
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-default">
									<div class="panel-heading">Form Tambah Data Asesor</div>
								<div class="panel-body">
									<form method="post" name="theform" action="drv_add.php" class="form-horizontal" onsubmit="return valid(this);" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-2 control-label">Nama Asesor<span style="color:red">*</span></label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<div class="col-sm-3">
											<div class="checkbox checkbox-inline">
												...
												<a href="driver.php" class="btn btn-default">Batal</a>
											</div>
										</div>
									</div>
								</div>
