			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Konfirmasi</h2>

						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Info Mahasiswa</div>
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<select id="status" name="status" class="form-control" onChange="changetextbox();" required>
														<?php
															$stt = $result['stt_trx'];
															echo "<option value='$stt' selected>".$stt."</option>";
															echo "<option value='Menunggu Upload KRS'>"."Menunggu Upload KRS"."</option>";
										...
										<div class="form-group">
											<label class="col-sm-2 control-label">Bukti KRS</label>
											<div class="col-sm-4">
