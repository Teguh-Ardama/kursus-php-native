...
<section class="user_profile inner_pages">
	...
	<div class="user_profile_info">	
        ...
        <form method="post" name="sewa" onSubmit="return valid();"> 
			...
			<?php if($result['stt_trx']=="Menunggu Upload KRS"){
				$sqlrek 	= "SELECT * FROM tblpages WHERE id='5'";
				$queryrek = mysqli_query($koneksidb,$sqlrek);
				$resultrek = mysqli_fetch_array($queryrek);
				?>
			<b>*Silahkan upload KRS ke <a href="booking_edit.php?kode=<?php echo $result['id_trx'];?>">upload bukti</a> maksimal tanggal <?php echo IndonesiaTgl($tglhasil);?>.
			<?php
			}else{
