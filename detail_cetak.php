...
<head>
	...
	<link href="admin/img/gunadarma.png" rel="icon" type="images/x-icon">
				...
				<tbody>
					<tr>
						<td rowspan="3" width="16%" class="text-center">
							<img src="admin/img/gunadarma.png" alt="logo-dkm" width="80" />
						</td>
						<td class="text-center"><h3>UniversitasJEWEPE.com</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center">Phone : +62 823-2275-3411 | E-mail : ask@universitasjewepe.com</td>
					</tr>
					<tr>
		...
		<div class="container-fluid">
			...
			<table class="table table-borderless">
				<tbody>
					...
					<?php
						if($result['stt_trx']=="Menunggu Upload KRS"){
						...
						<tr>
							<td colspan='3'>
								<b>*Silahkan upload KRS ke Upload KRS maksimal tanggal"?> <?php echo IndonesiaTgl($tglhasil);?> <?php echo ".
							</td>
						</tr>
							";
						}else{
