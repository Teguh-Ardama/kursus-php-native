...
<link rel="shortcut icon" href="admin/img/gunadarma.png">
      ...
      <aside class="col-md-3">
		<div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-envelope" aria-hidden="true"></i>Daftar Sekarang</h5>
          </div>
          <form method="get" action="booking.php">
			...
			<?php if($_SESSION['ulogin'])
              ...
              <div class="form-group" align="center">
                <button class="btn" align="center">Daftar Sekarang</button>
              </div>
              <?php } else { ?>
				<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login Untuk Daftar</a>
              <?php } ?>
          </form>
        </div>
