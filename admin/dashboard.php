									...
									<div class="col-md-6">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												...
												<?php 
												$sqlbayar = "SELECT id_trx FROM transaksi WHERE stt_trx='Menunggu Upload KRS'";
												...
												?>
													...
													<div class="stat-panel-title text-uppercase">Menunggu Upload KRS</div>
												</div>
											</div>
									...
									<div class="col-md-6">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
												<?php 
												$sqldrv = "SELECT id_trx FROM transaksi WHERE stt_trx='Terverifikasi' AND id_driver='0'";
												...
												?>
													...
													<div class="stat-panel-title text-uppercase">Menunggu Assign Asesor</div>
												</div>
											</div>
										...
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light">
												...
												$sqlkonfir = "SELECT transaksi.*, tmp_trx.* FROM transaksi, tmp_trx WHERE transaksi.id_trx=tmp_trx.id_trx
																AND tmp_trx.tanggal='$now' AND tmp_trx.status='Terverifikasi'";
												$querykonfir = mysqli_query($koneksidb,$sqlkonfir);
												$konfir=mysqli_num_rows($querykonfir);
												?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($konfir);?></div>
