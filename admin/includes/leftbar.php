	<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">			
				...
				<li><a href="#"><i class="fa fa-exchange"></i>Transaksi</a>
					<ul class="ts-sidebar-menu">
						<li><a href="trx_bayar.php">Menunggu Upload KRS</a></li>				  						
						<li><a href="trx_konfirmasi.php">Menunggu Konfirmasi</a></li>
						<li><a href="trx_drv.php">Assign Asesor</a></li>
				...
				<li><a href="driver.php"><i class="fa fa-users"></i> Asesor</a></li>
				<li><a href="reg-users.php"><i class="fa fa-users"></i> Mahasiswa</a></li>
