...
<section class="user_profile inner_pages">
			<center><h3>Upload KRS Aktif</h3></center>
	<div class="container">
	<div class="user_profile_info">	
        ...
        <form method="post" action="update_sewa.php" name="sewa" onSubmit="return valid();" enctype="multipart/form-data"> 
			...
			<label>Tanggal Selesai</label>
				<input type="text" class="form-control" name="fromdate" placeholder="" value="<?php echo IndonesiaTgl($result['tgl_selesai']);?>"readonly>
            </div>
            <div class="form-group">
			<label>Jam</label>
			...
			<div class="form-group">
			<label>Upload KRS Aktif</label><br/>
